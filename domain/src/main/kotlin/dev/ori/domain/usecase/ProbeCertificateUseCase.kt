...
class ProbeCertificateUseCase @Inject constructor(
    private val repository: ProxmoxRepository,
) {
    suspend operator fun invoke(host: String, port: Int): AppResult<String> =
        repository.probeCertificate(host, port)
}
